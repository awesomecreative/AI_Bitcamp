...
#2. model
model = Sequential()
model.add(Conv1D(700, 2, input_shape=(96, 32)))
model.add(Flatten())
...
"""
Epoch 10/10
1250/1250 [==============================] - 13s 10ms/step - loss: 3.5283 - acc: 0.1592 - val_loss: 3.4743 - val_acc: 0.1710
313/313 [==============================] - 1s 3ms/step - loss: 3.4703 - acc: 0.1774
loss :  3.4702773094177246
accuracy :  0.17739999294281006
time :  131.05920577049255
"""