...
#2. model
model = Sequential()
model.add(Conv2D(512, (4,2), input_shape=(8,4,2), padding='same', activation='relu'))
model.add(Conv2D(128, (4,2), activation='relu'))
model.add(Flatten())
...
"""
Epoch 80/1000
1143/1149 [============================>.] - ETA: 0s - loss: 0.2274 - accuracy: 0.9370Restoring model weights from the end of the best epoch: 30.

Epoch 00080: val_loss did not improve from 0.02917
1149/1149 [==============================] - 6s 5ms/step - loss: 0.2262 - accuracy: 0.9373 - val_loss: 0.1670 - val_accuracy: 0.9514
Epoch 00080: early stopping
12/12 [==============================] - 0s 6ms/step - loss: 0.0744 - accuracy: 0.9806
loss :  0.07440420985221863
accuracy :  0.980555534362793
y_predict :  [7 3 4 1 4 4 6 3 4 5 2 4 2 5 9 0 8 8 7 4 4 2 7 1 3 6 2 6 1 9 7 1 4 5 1 9 7
 2 4 7 3 7 6 7 4 8 5 1 2 1 2 7 6 1 1 2 8 8 6 6 6 2 3 4 0 7 9 3 5 0 4 4 1 8
 ...
 1 6 3 7 3 9 6 3 0 3 6 9 3 3 1 8 7 3 1 2 8 0 9 9 4 7 0 7 0 1 6 1 9 2 8 9 3
 6 0 1 8 8 0 7 0 9 0 4 9 9 2 1 2 5 5 9 8 0 3 5 0 6 1 4 1 9 8 6 8 4 5 8 6 1
 1 9 9 1 1 6 0 9 3 2 4 9 0 6 2 4 5 1 3 3 4 5 3 1 3 5 6 2 5 3 4 7 9 4 6 2 9
 0 6 0 8 4 0 4 7 7 0 6 0 3 1 0 6 8 2 3 2 3 3 6 2 9 8 0 6 5 7 1 2 6 7 1 5 2
 9 6 8 9 7 7 5 6 6 0 4 4 7 0 7 5 4 1 9 8 7 5 6 8 9 0 5 7 1 1 5 8 5 7 3 8 7
 3 5 8 2 3 7 3 8 7 3 1 9 0 8 9 0 7 4 4 0 5 1 1 9 4 5 3]
