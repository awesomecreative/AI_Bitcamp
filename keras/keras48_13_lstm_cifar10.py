...
#2. model
model = Sequential()
model.add(LSTM(512, input_shape=(96, 32), activation='relu'))
...
#                       filepath = filepath + 'LSTM_C10_' + date + '_' + filename)
...
"""
Epoch 5/5
1250/1250 [==============================] - 176s 141ms/step - loss: 2.3028 - acc: 0.0994 - val_loss: 2.3027 - val_acc: 0.0952
313/313 [==============================] - 12s 40ms/step - loss: 2.3026 - acc: 0.1000
loss :  2.3026175498962402
accuracy :  0.10000000149011612
time :  882.5738892555237
"""